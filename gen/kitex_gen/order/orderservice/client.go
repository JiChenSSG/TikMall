...
type Client interface {
	...
	MarkOrderCancelled(ctx context.Context, Req *order.CancelOrderReq, callOptions ...callopt.Option) (r *order.CancelOrderResp, err error)
	GetOrder(ctx context.Context, Req *order.GetOrderReq, callOptions ...callopt.Option) (r *order.GetOrderResp, err error)
	UpdateOrderInfo(ctx context.Context, Req *order.UpdateOrderInfoReq, callOptions ...callopt.Option) (r *order.UpdateOrderInfoResp, err error)
}
...
func (p *kOrderServiceClient) MarkOrderCancelled(ctx context.Context, Req *order.CancelOrderReq, callOptions ...callopt.Option) (r *order.CancelOrderResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.MarkOrderCancelled(ctx, Req)
}
...
func (p *kOrderServiceClient) UpdateOrderInfo(ctx context.Context, Req *order.UpdateOrderInfoReq, callOptions ...callopt.Option) (r *order.UpdateOrderInfoResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
